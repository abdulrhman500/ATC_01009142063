...
import { IsAuthorized } from '@api/middleware/isAuthorized.middleware'; // Adjust path
...
describe('IsAuthorized', () => {
    ...
    it('should call next() if user has an allowed role', () => {
        ...
        const middleware = IsAuthorized([RoleType.ADMIN, RoleType.ADMIN]);
    ...
    it('should call next() if user has one of multiple allowed roles', () => {
        ...
        const middleware = IsAuthorized([RoleType.ADMIN, RoleType.CUSTOMER]);
    ...
    it('should call next with UnauthorizedException if req.user is not defined', () => {
        ...
        const middleware = IsAuthorized([RoleType.ADMIN]);
    ...
    it('should allow access if allowedRoles is an empty array (meaning any authenticated user)', () => {
        ...
        const middleware = IsAuthorized([]); // No specific roles required, just authentication
